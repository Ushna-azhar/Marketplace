      ...
      <div className="container mx-auto text-center">
        ...
        <div className="relative">
          <div className="flex justify-center gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full sm:w-64 transition-all duration-300 ease-in-out">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 transform -translate-y-1/2 text-white bg-black p-3 rounded-full shadow-lg focus:outline-none hover:bg-gray-700"
          >
            &#8592;
          </button>
          <button
            onClick={nextTestimonial}
            className="absolute right-0 top-1/2 transform -translate-y-1/2 text-white bg-black p-3 rounded-full shadow-lg focus:outline-none hover:bg-gray-700"
          >
            &#8594;
          </button>
        </div>
