    ...
    <div className="admin-dashboard">
      ...
      <div className="mb-6">
        ...
        <form onSubmit={handleSubmit(onSubmitProduct)} className="space-y-4">
          ...
          <button type="submit" className="bg-blue-500 text-white p-2 rounded">Submit Product</button>
        </form>
      </div>
      ...
      <div className="mb-6">
        ...
        <form onSubmit={handleSubmit(onSubmitDiscount)} className="space-y-4">
          ...
          <button type="submit" className="bg-blue-500 text-white p-2 rounded">Submit Discount</button>
        </form>
      </div>
      ...
      <div className="mb-6">
        ...
        <form onSubmit={handleSubmit(onSubmitCoupon)} className="space-y-4">
          ...
          <button type="submit" className="bg-blue-500 text-white p-2 rounded">Submit Coupon</button>
        </form>
      </div>
